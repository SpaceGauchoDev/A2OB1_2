...
public class TestsObligatorio1_3 {
	...
	public void testBuscarUsuarioRaizOrden() {
		...
		//assertEquals(1, retorno.valorEntero); // sospecho que este valor está equivocado
	...
	public void testBuscarUsuarioHoja() {
		...
		//assertEquals(4, retorno.valorEntero); // sospecho que este valor está equivocado	
	...
	public void testBuscarUsuarioHojaOrden() {
		...
		//assertEquals(5, retorno.valorEntero); // sospecho que este valor está equivocado
		assertEquals(3, retorno.valorEntero); 
	}
